...
public interface AcademyConst {
    ...
    Academy academy = new Academy(1L, "권경렬", "윤선생영어교실 석포초점", "051-111-1111", "010-1111-1111", UserConst.academyUser, null, AcademyStatus.ACTIVE);

    AcademySaveRequest academySaveRequest = new AcademySaveRequest("권경렬", "윤선생영어교실 석포초점", "051-111-1111", "010-1111-1111", UserConst.saveRequest);
}